...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(maq.agua() == 0); // True
        System.out.println(maq.copos200() == 0); // True
        System.out.println(maq.copos300() == 0); // True
        ...
        maq.abastecerAgua(); // Abastecido ...
        System.out.println(maq.agua() == 20000); // True

        maq.abastecerAgua(); // Máquina Já está cheia
        System.out.println(maq.agua() == 20000); // True

        maq.servirCopo200(); // Não é possível servir copos no momento ...
        System.out.println(maq.agua() == 20000); // True

        System.out.println(maq.copos200() == 0); // True
        maq.abastecerCopo200(); // Copos Abastecidos
        System.out.println(maq.copos200() == 100); // True
